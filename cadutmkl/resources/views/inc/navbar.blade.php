    <nav class="navbar navbar-expand-lg navbar-light justify-content-right navbar-mobile fixed-top navfix">
      <div class="container">
        <a class="navbar-brand" href="/"> <img src="images/cadLogo.png" alt="cadLogo" width="50" />&nbsp;&nbsp;<b>CADUTMKL</b></a>
        ...
        <ul class="navbar-nav d-menu">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="user" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img src="images/userLogo.png" alt="userLogo" width="35"/>
            </a>
...
<ul class="first-nav">
  ...
  <li><a href="#"><img src="images/userLogo.png" alt="userLogo" width="35"/></a>
    <ul>
